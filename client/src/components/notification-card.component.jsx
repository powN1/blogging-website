...
const NotificationCard = ({ data, index, notificationState }) => {
	...
	return (
		<div className={"p-6 border-b border-grey border-l-black " + (!seen ? "border-l-2" : null)}>
			<div className="flex gap-5 mb-3">
				...
				<div className="w-full">
					<h1 className="font-medium text-xl text-dark-grey">
						...
						<span className="font-normal">{type === "like" ? "liked your blog" : type === "comment" ? "commented on" : "replied on"}</span>
					</h1>
					{
						type === "reply" ? (
			...
			<div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8">
				...
				{type !== "like" ? (
					<>
						...
						<button className="underline hover:text-black" onClick={e => handleDeleteClick(comment._id, "comment", e.target)}>
							Delete
						</button>
					</>
				) : (
			...
			{reply ? (
				<div className="ml-20 p-5 bg-grey mt-5 rounded-md">
					<div className="flex gap-3 mb-3">
						<img src={author_profile_img} alt="user profile img" className="w-8 h-8 rounded-full" />
						<div>
							<h1 className="font-medium text-xl text-dark-grey">
					...
					<button className="underline hover:text-black ml-14 mt-2" onClick={e => handleDeleteClick(reply._id, "reply", e.target)}>
						Delete
					</button>
				</div>
			) : null}
