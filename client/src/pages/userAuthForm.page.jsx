...
const UserAuthForm = ({ type }) => {
  ...
  const handleDemoAuth = (e) => {
    e.preventDefault();
    const formData = { email: import.meta.env.VITE_DEMO_ACC_EMAIL, password: import.meta.env.VITE_DEMO_ACC_PASSWORD };
    userAuthThroughServer("/api/signin", formData);
  };
    ...
    <AnimationWrapper keyValue={type}>
      <section className="h-cover flex items-center justify-center">
        ...
        <form id="formElement" className="w-[90%] md:w-2/3 lg:w-1/4 max-width-[400px]">
          ...
          >
            <img className="w-5" src={logo} alt="inkspire icon" />
